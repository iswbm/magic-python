...
.. image:: http://image.iswbm.com/image-20200903214325849.png
...
+---+-----------------------------------------------------------+-------+
| t | ISO 8601 format date/time e.g. 1972-01-20T10:21:36Z (“T”  | dat   |
| i | and “Z” optional)                                         | etime |
+---+-----------------------------------------------------------+-------+
| t | RFC2822 e-mail format date/time e.g. Mon, 20 Jan 1972     | dat   |
| e | 10:21:36 +1000                                            | etime |
+---+-----------------------------------------------------------+-------+
| t | Global (day/month) format date/time e.g. 20/1/1972        | dat   |
| g | 10:21:36 AM +1:00                                         | etime |
+---+-----------------------------------------------------------+-------+
| t | US (month/day) format date/time e.g. 1/20/1972 10:21:36   | dat   |
| a | PM +10:30                                                 | etime |
+---+-----------------------------------------------------------+-------+
| t | ctime() format date/time e.g. Sun Sep 16 01:03:52 1973    | dat   |
| c |                                                           | etime |
+---+-----------------------------------------------------------+-------+
| t | HTTP log format date/time e.g. 21/Nov/2011:00:07:11 +0000 | dat   |
| h |                                                           | etime |
+---+-----------------------------------------------------------+-------+
| t | Linux system log format date/time e.g. Nov 9 03:37:44     | dat   |
| s |                                                           | etime |
+---+-----------------------------------------------------------+-------+
